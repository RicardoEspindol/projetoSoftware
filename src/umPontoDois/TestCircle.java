...
public class TestCircle {
	...
	public static void main(String[] args) {
		...
		// Declare an instance of Circle class called c1.
	      ...
	      // Resuloção
	      // c1.radius=5.0; // Não é possível realizar diretamente valores ao atributo "radius" por estar "private" o argumento. 
	      // Uma forma de resolvermos essa questão é tornando-o publico ou addicionando um método GET para "radius" na classe Circle. 
	      ...
	      //System.out.println(c4.setRadius(4.4)); -- imposible 
